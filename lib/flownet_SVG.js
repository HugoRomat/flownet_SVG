...
flownet_svg_graph.prototype.force_layout = function (delay, center) {
  ...
  if (typeof center !== 'undefined') this.simulation.force("center", __WEBPACK_IMPORTED_MODULE_0_d3__["k" /* forceCenter */](center.x, center.y));else this.simulation.force("center", __WEBPACK_IMPORTED_MODULE_0_d3__["k" /* forceCenter */](0, 0));
    ...
    if (!svgProp) {
      ...
      if (svgProp === "cx" || svgProp === "cy") {
        this.groupGraph.select('#links').selectAll('g').filter(function () {
          ...
          __WEBPACK_IMPORTED_MODULE_3__biblio_svg_graph_links_js__["b" /* updateLinkPoints */](that.groupGraph.select("#nodes").select("#node_" + d.source), this, that.groupGraph.select("#nodes").select("#node_" + d.target));
        });
      }
    }
  }
  ...
  switch (property) {
    case 'computationalMethod':
      this.groupGraph.select('#links').selectAll('path').filter(function (d, i) {
        ...
        return __WEBPACK_IMPORTED_MODULE_4__biblio_svg_graph_particules_js__["a" /* computeParticleRender */](this.getAttribute('computationalMethod'), this.getAttribute('frequency'), this.getAttribute('spacing'), this.getAttribute('speed'), this.getAttribute('visual_pattern'));
      });
      break;
    ...
    case 'spacing':
      ...
      this.groupGraph.select('#links').selectAll('path').filter(function (d, i) {
        ...
        return __WEBPACK_IMPORTED_MODULE_4__biblio_svg_graph_particules_js__["a" /* computeParticleRender */](this.getAttribute('lastModify'), this.getAttribute('frequency'), this.getAttribute('spacing'), this.getAttribute('speed'), this.getAttribute('visual_pattern'));
      });
      break;
...
flownet_svg_subgraph.prototype.select = function (id) {
  ...
  let particles = this.particles.filter(function () {
    return this.getAttribute("id").split('_')[1] === id && this.getAttribute("id").split('_')[0] === "link";
  });
...
flownet_svg_subgraph.prototype.filters = function (fun) {
  ...
  let particles = this.particles.filter(function (d, i) {
    return fun(d, i);
  });
...
flownet_svg_subgraph.prototype.link_properties = function (property, value) {
  ...
  if (property === 'interpolation') {
    ...
    this.particles.selectAll('g').filter(function (d, i) {
      if (!filter) return true;
      if (typeof filter === 'function') return filter(d, i);
      return filter;
    }).filter(function () {
